...
Este objeto contiene las reglas de acceso en la app (la función authorized).

En la versión 5 de Auth.js, la propiedad .auth devuelve una función que Next.js reconoce
como un Proxy. Al hacer export default, le estás diciendo a Next.js:
"Usa esta lógica para filtrar todas las peticiones que entren a la aplicación".
*/
export default NextAuth(authConfig).auth;

export const config = {
  /* Configura el matcher para que el proxy se ejecute en todas las rutas
...
del archivo auth.ts porque los proxies de Next.js corren en el Edge Runtime, el cual
